...
public class ShowHealth : MonoBehaviour 
{
	...
	void FixedUpdate () 
    {
        ...
        if (gameObject.GetComponent<Soul>().ship_name == "enemy2" || gameObject.GetComponent<Soul>().ship_name == "enemy3" || gameObject.GetComponent<Soul>().ship_name == "enemy4" || gameObject.GetComponent<Soul>().ship_name == "enemy5" || gameObject.GetComponent<Soul>().ship_name == "enemy6") health.transform.position = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z + 4f);
    }
