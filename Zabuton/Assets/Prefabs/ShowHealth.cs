...
public class ShowHealth : MonoBehaviour 
{
	...
	void FixedUpdate () 
    {
        ...
        else if (gameObject.GetComponent<Soul>().ship_name == "boss2" || gameObject.GetComponent<Soul>().ship_name == "boss1" || gameObject.GetComponent<Soul>().ship_name == "enemy11" || gameObject.GetComponent<Soul>().ship_name == "enemy2" || gameObject.GetComponent<Soul>().ship_name == "enemy3" || gameObject.GetComponent<Soul>().ship_name == "enemy4" || gameObject.GetComponent<Soul>().ship_name == "enemy12" || gameObject.GetComponent<Soul>().ship_name == "enemy5" || gameObject.GetComponent<Soul>().ship_name == "enemy6") health.transform.position = new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z + 4f);
